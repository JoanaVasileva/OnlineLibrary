...
class BookList extends Component {
  ...
  render() {
    ...
    const categories = ["Екшън", "Биографични", "Исторически", "Ужаси", "Детски", "Научни", "Научнофантастичен"];
    ...
    return (
      <Container style={{marginBottom: "20px"}}>
        ...
        />
        <CategoryFilter selectedCategory={selectedFilter} categories={[' ',...categories]} onChange={this.handleFilterChange}/>
        <ListGroup>
